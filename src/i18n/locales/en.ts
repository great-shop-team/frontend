const en = {
  ...
  checkout: {
    ...
    email: 'E-mail',
    emailPlaceholder: 'JS@gmail.com',
    deliveryMethod: 'Delivery Method',
    shippingInfo: 'Shipping information',
    country: 'Country',
    city: 'City',
    warehouse: 'Post office and parcel lockers in your city',
    notes: 'Delivery Notes',
    saveAddress: 'Save this address for future orders',
    paymentMethod: 'Payment Method',
    agree: 'I agree with Terms & Privacy Policy',
    terms: 'Terms',
    ...
    apply: 'Apply',
    promoUnavailable: 'Promo codes are not available yet.',
    subtotal: 'Subtotal',
    discount: 'Discount',
    shippingFee: 'Shipping fee',
    total: 'Total',
    secureTitle: 'Secure & Trusted Checkout',
    confirm: 'Order Confirmation',
    ssl: '256-bit SSL Encryption',
    emptyTitle: 'Your cart is empty',
    emptyText: 'Add items before placing an order.',
    toCatalog: 'Go to catalog',
    required: 'This field is required.',
    invalidEmail: 'Enter a valid email address.',
    invalidPhone: 'Enter the mobile number without the country code.',
    selectCity: 'Choose a city from the list.',
    selectWarehouse: 'Choose a post office or parcel locker.',
    agreeRequired: 'Confirm the terms and privacy policy.',
    selectPayment: 'Choose a payment method.',
    noEndpoint:
      'The form is filled in. The store has no order endpoint yet, so the order is not sent to email or the admin panel.',
    loadError: 'Could not load Nova Poshta data.',
    npOnlyUkraine: 'Nova Poshta post offices and parcel lockers are available in Ukraine.',
