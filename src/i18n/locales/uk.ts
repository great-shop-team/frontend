...
const uk: Dictionary = {
  ...
  stub: {
    ...
    checkout: {
      ...
      description: 'Сторінка оформлення замовлення з’явиться незабаром.',
      cta: 'До каталогу',
    },
    sales: {
      title: 'Знижки',
  ...
  cartDrawer: {
    ...
    shippingNote: 'Безкоштовна доставка та повернення по всьому світу',
    ...
    emptyTitle: 'Тут ще нічого немає',
    emptyText: 'Кошик чекає на товари. Знайдіть те, що вам до душі',
  ...
  checkout: {
    metaTitle: 'Оформлення замовлення',
    ...
    country: 'Країна',
    city: 'Місто',
    warehouse: 'Відділення та поштомати у вашому місті',
    notes: 'Коментар до доставки',
    saveAddress: 'Зберегти цю адресу для наступних замовлень',
    paymentMethod: 'Спосіб оплати',
    agree: 'Я погоджуюсь з Умовами та Політикою конфіденційності',
    terms: 'Умовами',
    ...
    size: 'Розмір',
    estimatedTotal: 'Орієнтовна сума',
    promo: 'Додати промокод',
    apply: 'Застосувати',
    promoUnavailable: 'Промокоди поки не працюють.',
    subtotal: 'Проміжна сума',
    discount: 'Знижка',
    shippingFee: 'Доставка',
    total: 'Разом',
    secureTitle: 'Безпечне оформлення',
    confirm: 'Підтвердити замовлення',
    ssl: '256-бітне SSL-шифрування',
    emptyTitle: 'Кошик порожній',
    emptyText: 'Додайте товари, перш ніж оформлювати замовлення.',
    toCatalog: 'До каталогу',
    required: "Це поле обов'язкове.",
    invalidEmail: 'Введіть коректну email-адресу.',
    invalidPhone: 'Введіть номер мобільного без коду країни.',
    selectCity: 'Оберіть місто зі списку.',
    selectWarehouse: 'Оберіть відділення або поштомат.',
    agreeRequired: 'Підтвердіть згоду з умовами та політикою конфіденційності.',
    selectPayment: 'Оберіть спосіб оплати.',
    noEndpoint:
      'Форму заповнено. На бекенді ще немає ендпоінта замовлення, тому воно не відправляється на пошту чи в адмінку.',
    loadError: 'Не вдалося завантажити дані Нової пошти.',
    npOnlyUkraine: 'Відділення та поштомати Нової пошти доступні в Україні.',
    noMatches: 'Нічого не знайдено.',
    decrease: 'Зменшити кількість',
    increase: 'Збільшити кількість',
    remove: 'Видалити з замовлення',
    novaPoshta: 'Нова пошта',
    phoneCode: 'Телефонний код країни',
