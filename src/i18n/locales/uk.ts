...
const uk: Dictionary = {
  ...
  catalog: {
    ...
    allBannerTitle: 'Увесь каталог',
    allBannerDescription:
      'Одяг, взуття та аксесуари в одному місці. Перегляньте всю колекцію WEARLY і знайдіть свою наступну базу.',
    ...
    categories: {
      men: {
        ...
        bannerTitle: 'Відкрийте свій фірмовий стиль',
        bannerDescription:
          'Увійдіть у світ сучасного чоловічого одягу, де кожна деталь віддзеркалює впевненість. Відкрийте вишукану базу та позачасові речі, створені, щоб підняти ваш повсякденний образ.',
      },
      women: {
        navLabel: 'Жінкам',
        title: 'Жіночий каталог',
        bannerImageAlt: 'Банер жіночого каталогу',
        bannerTitle: 'Створено для кожного вашого моменту',
        bannerDescription:
          'Сучасні силуети. Легка впевненість. Гардероб, який відчувається цілком вашим. Відкрийте ретельно дібраний жіночий одяг, що приносить стиль у повсякденність — від розслабленої бази до акцентних речей, які виділяються.',
      },
      accessories: {
        navLabel: 'Аксесуари',
        title: 'Аксесуари',
        bannerImageAlt: 'Банер каталогу аксесуарів',
        bannerTitle: 'Аксесуари, що визначають вас',
        bannerDescription:
          'Відкрийте деталі, що завершують образ. Від щоденної бази до акцентних речей — знайдіть нові улюблені.',
      },
      fragrances: {
        navLabel: 'Парфуми',
        title: 'Парфуми',
        bannerImageAlt: 'Банер каталогу парфумів',
      ...
      shoes: {
        navLabel: 'Взуття',
        title: 'Взуття',
        bannerImageAlt: 'Банер каталогу взуття',
        bannerTitle: 'Знайдіть свою наступну улюблену пару',
        bannerDescription:
          'Оберіть стилі для кожного кроку. Позачасові речі та нові улюблені, створені рухатися разом із вами.',
      },
    },
  },
  landing: {
    ...
    removeFromWishlist: 'Прибрати з обраного',
    add: 'Додати',
