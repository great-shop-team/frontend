export const catalogSection = {
  ...
  bannerContent:
    'layout-gutter relative z-1 mx-0 mr-auto box-border flex h-full w-full max-w-[600px] flex-col justify-center pt-[calc(var(--site-header-height)+24px)] pb-16',
  bannerTitle:
...
export const catalogPage = {
  content: 'scroll-mt-[var(--site-header-height)]',
} as const;
